...
public class GlassGarbage : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Glass_can"))
        {
        ...
        if (collision.gameObject.CompareTag("Plastic_can") || collision.gameObject.CompareTag("Paper_can") || collision.gameObject.CompareTag("Organic_can") || collision.gameObject.CompareTag("Metal_can"))
        {
